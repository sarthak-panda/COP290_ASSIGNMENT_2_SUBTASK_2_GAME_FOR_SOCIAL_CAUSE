...
controls.maxAzimuthAngle = Math.PI / 2; // Maximum horizontal rotation (radians)
controls.minAzimuthAngle = Math.PI / 7; // Minimum horizontal rotation (radians)
